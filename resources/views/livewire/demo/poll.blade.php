...
<div class="lg:grid-cols-6 grid h-[700px]">
    <div class="p-8 pb-12 overflow-y-scroll border-r border-red-800 lg:col-span-2">
        ...
        <ul class="mt-8 space-y-6" wire:poll> {{-- [tl! highlight] --}}
        ...
        <div class="mt-8">{{ $events->links() }}</div> {{-- [tl! highlight] --}}
    </div>
    <div class="flex flex-col overflow-x-auto text-sm lg:col-span-4">
        <button class="text-center text-white" wire:click="createDummyEvents">Create Dummy Events</button>
        @if($selectedEvent)
            <div class="p-8">
